...
function changeUnits(rowNo) {
    ...
    console.log(servicedropdown.value);
    if(servicedropdown.value == 1) {
        if(document.getElementById("unit_price" + rowNo).value<1 || document.getElementById("unit_price" + rowNo).value == 50 || document.getElementById("unit_price" + rowNo).value == 100)
        ...
        if(document.getElementById("unit_price" + rowNo).value<1 || document.getElementById("unit_price" + rowNo).value == 10 || document.getElementById("unit_price" + rowNo).value == 100)
        ...
        if(document.getElementById("unit_price" + rowNo).value<1 || document.getElementById("unit_price" + rowNo).value == 50 || document.getElementById("unit_price" + rowNo).value == 10)
